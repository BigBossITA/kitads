  ...
  return (
    <div style={DS.sidebar}>
      <div style={DS.sidebarTop}>
        <img src={window.__resources.logoWhite} alt="KitAds" style={{ cursor: 'pointer', filter: 'brightness(10)', objectFit: "contain", width: "35.9961px", height: "35.9961px" }} onClick={onBackToLanding} />
      </div>
