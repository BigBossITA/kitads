    ...
    <div style={landingStyles.root}>
      ...
      <nav style={landingStyles.nav}>
        <div style={landingStyles.navInner}>
          <div style={landingStyles.logo}>
            <img src={window.__resources.logoWhite} alt="KitAds" style={{ height: 32, objectFit: 'contain', filter: 'brightness(10)' }} />
          </div>
              ...
              <div style={landingStyles.previewGrid}>
                ...
                <div style={landingStyles.previewCard}>
                  <div style={landingStyles.previewCardMedia}>
                    <img src={window.__resources.foxImg} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain', opacity: 0.85 }} />
      ...
      <footer style={landingStyles.footer}>
        <div style={landingStyles.footerInner}>
          <img src={window.__resources.logoWhite} alt="KitAds" style={{ height: 32, objectFit: 'contain', marginBottom: 16, filter: 'brightness(10)' }} />
...
const landingStyles = {
  ...
  spotStep: { flex: 1, padding: '32px 24px', borderLeft: '1px solid #1E1B42' },
